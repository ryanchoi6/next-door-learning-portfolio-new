...
export const projects: Project[] = [
  ...
  {
    id: "catapult-physics",
    title: "Catapult Physics Lab",
    thumbnail: "",
    shortIntro: "Students built catapults to explore projectile motion, force, and energy transfer.",
  ...
  },
  {
    ...
    thumbnail: "",
    shortIntro: "Students competed to build the tallest free-standing tower that could support a weighted load.",
  ...
  },
  {
    ...
    thumbnail: "",
    shortIntro: "Students designed and tested wind turbine blades for optimal energy output.",
  ...
  },
  {
    ...
    title: "Paper Roller Coaster Engineering",
    thumbnail: "",
    shortIntro: "Students engineered roller coasters from cardstock, exploring gravity, momentum, and loops.",
  ...
  {
    id: "geodesic-dome",
    title: "Geodesic Dome Construction",
    thumbnail: "",
    shortIntro: "Teams built geodesic domes and studied triangular load distribution and geometric stability.",
